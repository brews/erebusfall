...
def test_icevol_correction():
    victim = erebus.icevol_correction(np.arange(1, 21), [1] * 20, timeunit='ka')
...
def test_icevol_correction_extraheads():
    victim = erebus.icevol_correction(np.arange(-5, 21), [1] * 26, timeunit='ka')
...
def test_icevol_correction_extratails():
    victim = erebus.icevol_correction(np.arange(5315, 5325), [1] * 10, timeunit='ka')
